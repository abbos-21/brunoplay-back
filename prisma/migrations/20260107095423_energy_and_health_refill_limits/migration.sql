...
CREATE TABLE "new_User" (
    ...
    "canRefillEnergy" BOOLEAN NOT NULL DEFAULT true,
    "canRefillHealth" BOOLEAN NOT NULL DEFAULT true,
    "energyRefillPerDay" INTEGER NOT NULL DEFAULT 20,
    "healthRefillPerDay" INTEGER NOT NULL DEFAULT 20,
