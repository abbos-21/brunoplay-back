/*
  ...
  - You are about to drop the column `canRefillEnergy` on the `User` table. All the data in the column will be lost.
  - You are about to drop the column `canRefillHealth` on the `User` table. All the data in the column will be lost.
  - You are about to drop the column `energyRefillPerDay` on the `User` table. All the data in the column will be lost.
  - You are about to drop the column `healthRefillPerDay` on the `User` table. All the data in the column will be lost.
